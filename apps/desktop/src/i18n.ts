...
const dict = {
  ...
  "settings.activity": { en: "Activity", de: "Aktivität", fr: "Activité", it: "Attività", pt: "Atividade" },
  "activity.last7": { en: "Last 7 days", de: "Letzte 7 Tage", fr: "7 derniers jours", it: "Ultimi 7 giorni", pt: "Últimos 7 dias" },
  "activity.last30": { en: "Last 30 days", de: "Letzte 30 Tage", fr: "30 derniers jours", it: "Ultimi 30 giorni", pt: "Últimos 30 dias" },
  "activity.group.chat": { en: "Chat", de: "Chat", fr: "Chat", it: "Chat", pt: "Chat" },
  "activity.group.search": { en: "Search", de: "Suche", fr: "Recherche", it: "Ricerca", pt: "Pesquisa" },
  "activity.group.reading": { en: "Reading", de: "Lektüre", fr: "Lecture", it: "Lettura", pt: "Leitura" },
  "activity.group.management": { en: "Management", de: "Verwaltung", fr: "Gestion", it: "Gestione", pt: "Gestão" },
  "activity.group.errors": { en: "Errors", de: "Fehler", fr: "Erreurs", it: "Errori", pt: "Erros" },
  "activity.all": { en: "All", de: "Alle", fr: "Tous", it: "Tutti", pt: "Todos" },
  "activity.range7": { en: "7 days", de: "7 Tage", fr: "7 jours", it: "7 giorni", pt: "7 dias" },
  "activity.range30": { en: "30 days", de: "30 Tage", fr: "30 jours", it: "30 giorni", pt: "30 dias" },
  "activity.range90": { en: "90 days", de: "90 Tage", fr: "90 jours", it: "90 giorni", pt: "90 dias" },
  "activity.export": { en: "Export JSONL", de: "JSONL exportieren", fr: "Exporter JSONL", it: "Esporta JSONL", pt: "Exportar JSONL" },
  "activity.exported": { en: "Activity log exported.", de: "Aktivitätsprotokoll exportiert.", fr: "Journal d'activité exporté.", it: "Registro attività esportato.", pt: "Registo de atividade exportado." },
  "activity.exportError": { en: "Export failed.", de: "Export fehlgeschlagen.", fr: "Échec de l'exportation.", it: "Esportazione non riuscita.", pt: "A exportação falhou." },
  "activity.empty": { en: "No events in this range.", de: "Keine Ereignisse in diesem Zeitraum.", fr: "Aucun événement dans cette période.", it: "Nessun evento in questo intervallo.", pt: "Sem eventos neste intervalo." },
  "activity.error": { en: "Could not load activity.", de: "Aktivität konnte nicht geladen werden.", fr: "Impossible de charger l'activité.", it: "Impossibile caricare l'attività.", pt: "Não foi possível carregar a atividade." },
  "activity.prev": { en: "Previous page", de: "Vorherige Seite", fr: "Page précédente", it: "Pagina precedente", pt: "Página anterior" },
  "activity.next": { en: "Next page", de: "Nächste Seite", fr: "Page suivante", it: "Pagina successiva", pt: "Página seguinte" },
  "activity.outcome.done": { en: "answered", de: "beantwortet", fr: "répondu", it: "risposto", pt: "respondido" },
  "activity.outcome.stopped": { en: "stopped", de: "gestoppt", fr: "interrompu", it: "interrotto", pt: "interrompido" },
  "activity.outcome.failed": { en: "failed", de: "fehlgeschlagen", fr: "échoué", it: "fallito", pt: "falhou" },
  "activity.refusal": { en: "refusal", de: "Ablehnung", fr: "refus", it: "rifiuto", pt: "recusa" },
  "activity.citations": { en: "{n} citations", de: "{n} Zitate", fr: "{n} citations", it: "{n} citazioni", pt: "{n} citações" },
